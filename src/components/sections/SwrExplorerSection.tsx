        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="text-left border-b border-gray-100">
              <th className="pb-2 text-xs font-medium text-gray-400">{t.swrCol}</th>
              <th className="pb-2 text-xs font-medium text-gray-400">{t.fireNumberCol}</th>
              <th className="pb-2 text-xs font-medium text-gray-400">{t.yearsToFireCol}</th>
              <th className="pb-2 text-xs font-medium text-gray-400">{t.survivesCol}</th>
            </tr>
          </thead>
          <tbody>
            {scenarios.map((s) => (
              <tr key={s.swr} className="border-b border-gray-50 last:border-0">
                <td className="py-2 font-medium text-gray-700">{fmt.percent(s.swr)}</td>
                <td className="py-2 text-gray-600 tabular-nums">{fmt.currency(s.fireNumber)}</td>
