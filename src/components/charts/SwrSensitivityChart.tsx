  ...
  return (
    <ResponsiveContainer width="100%" height={220}>
      <ComposedChart data={data} margin={{ top: 8, right: 40, bottom: 0, left: 8 }}>
        ...
        <YAxis yAxisId="left" tickFormatter={fmt.currencyCompact} tick={{ fontSize: 11, fill: DARK.text }} width={60} />
        <YAxis yAxisId="right" orientation="right" tick={{ fontSize: 11, fill: DARK.text }} width={36} />
        <Tooltip
        ...
        <Bar yAxisId="left" dataKey={t.fireNumber} fill="#4f46e5" radius={[4, 4, 0, 0]} opacity={0.8} />
        <Line yAxisId="right" type="monotone" dataKey={t.yearsToFireCol} stroke="#818cf8" strokeWidth={2} dot={{ r: 4, fill: '#818cf8' }} />
        <Line yAxisId="right" type="monotone" dataKey={t.longevity} stroke="#34d399" strokeWidth={2} dot={{ r: 4, fill: '#34d399' }} strokeDasharray="5 3" />
      </ComposedChart>
    </ResponsiveContainer>
  )
}
